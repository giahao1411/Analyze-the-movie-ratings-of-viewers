...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(String.valueOf(movieManagement.getMovies().size() +
                movieManagement.getUsers().size()));
        System.out.println(movieManagement.getRating().size());
        movieManagement.findMoviesByNameAndMatchRating(1, 5);
        movieManagement.findUsersHavingSameRatingWithUser(1, 1193);
        movieManagement.findMoviesNameHavingSameReputation();
        movieManagement.findMoviesMatchOccupationAndGender("Lawyer", "M", 20, 3);
        movieManagement.findMoviesByOccupationAndLessThanRating("Lawyer", 20, 2);
        movieManagement.findMoviesMatchLatestMovieOf(3, 3, 20);
